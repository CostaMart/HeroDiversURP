...
public class EntityManager : MonoBehaviour
{
    ...
    private void InitializeDefaultEntities()
    {
        ...
        {
            GameObject spawner = InstantiateEntity("Spawner_0", _spawnerPrefab, _spawnerPrefab.transform.position, Quaternion.identity);
        }
        else
        {
    ...
    public string RegisterEntity(string id, GameObject entity)
    {
        ...
        while (_entities.ContainsKey(uniqueId))
        {
        ...
        OnEntityRegistered?.Invoke(uniqueId, entity);
