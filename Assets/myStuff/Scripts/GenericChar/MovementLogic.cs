...
public class MovementLogic : MonoBehaviour
{
    ...
    void OnEnable()
    {
        ...
        playerInput.actions["Aim"].performed += SetAiming;
        playerInput.actions["Aim"].canceled += SetNotAiming;
        playerInput.actions["Strafe"].performed += TryStrafe;
    }
    void OnDisable()
    {
        eventChannels.removeEvent("BurstOn");
        eventChannels.removeEvent("BurstOff");
        eventChannels.removeEvent("Jump");
        eventChannels.removeEvent("BurstEngineFail");
    ...
    void SetAiming(CallbackContext ctx)
    {
        Aiming = true;
    }

    void SetNotAiming(CallbackContext ctx)
    {
        Aiming = false;
    }
