...
public class FireWeaponLogic : AbstractWeaponLogic
{
    ...
    public override void onFireStart() { shooting = true; }

    public override void onFireStop() { shooting = false; smoke.transform.position = weaponContainer.muzzle.position; }
    ...
    public override void Shoot()
    {
        ...
        if (weaponContainer.currentAmmo >= weaponContainer.dispatcher.GetAllFeatureByType<int>(FeatureType.magSize).Sum()) return;
    ...
    public void BulletSetUp(GameObject b, Rigidbody rb, BulletLogic bulletLogic)
    {
        ...
        bulletLogic.toDispatch = ItemManager.bulletPool[key];
